...
const links = [
  ...
  { href: "/portal/compliance", label: "DfE compliance", icon: ShieldCheck, roles: ["TENANT_ADMIN", "AGENT", "SUPER_ADMIN"], group: "tools" },
          ...
          {items.map((item) => {
            ...
            return (
              <Link
                ...
                className="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm text-slate-700 hover:bg-slate-100"
              >
